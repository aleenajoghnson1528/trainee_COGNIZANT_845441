...
namespace Dbfirstconsoleapp
{
    class Program
    {
        static examinationEntities mf = new examinationEntities();
        ...
        private static void selectschools()
        {
        ...
        private static void selectcorses()
        {
        ...
        private static void insertintoexam()
        {
        ...
        private static void inserttoschool()
        {
            int i = 1;
            while (i != 0)
            {
